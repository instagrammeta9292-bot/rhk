...
// Session protection: Keeps user signed in until explicit logout action
  ...
  feedContainer.innerHTML = `
    <div class="post-card">
      ...
      <div class="post-footer">
        <p class="post-caption"><span>${currentUserData.username}</span> Welcome to your active RHK brand feed! All pages are now fully interconnected. 🚀</p>
      </div>
    </div>
  `;
}
